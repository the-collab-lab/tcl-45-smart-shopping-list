	...
	return (
		<>
			...
			<article className="about-article">
				...
				<p>
					Getting started with Shop-Ade is easy! On your first visit, simply
					create a new list and start adding the items that you need to
					purchase. Include the frequency at which you typically buy them to
					help the app get smarter (do you buy toilet paper on the weekly?
					lobster rolls every month?).
				</p>
				<p>
				...
				<details>
					<summary>Deleting Item</summary>
					If you want to delete an item from your list - click X button near the
					item name. You will see a confirmation dialog, if you select OK in the
					dialog window the item will be immediately deleted.
				</details>
				<details>
					<summary>Marking Item as Purchased</summary>If you bought an item -
					mark it as purchased in the list by putting a checkmark. The item will
					uncheck itself after 24 hours. The app will use the purchase
					information to predict next purchase and will move the item to one of
					the four time frames. If you marked something as purchased by mistake
					you can uncheck it manually. The item purchase history will be
					restored.
				</details>
				<details>
					<summary>Sharing List</summary>
					To share the list - click Copy Name button, the list name will be
					copied to the clipboard so you can send it to others.
				</details>
				<details>
					<summary>Logging Out</summary>If you want to leave the list - click
					Log Out button. You will see a confirmation dialog asking you to
					proceed with the action or cancel it. If you select OK, the window
					will close and you will be transferred to the Home screen.
				</details>
			</article>
			<article className="about-article">
